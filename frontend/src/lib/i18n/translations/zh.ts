...
export const zhTranslations = {
  ...
  insights: {
    ...
    failedToGenerateWeekly: "生成每周摘要失败。",
    failedToGenerateSummary: "生成摘要失败。",
    notEnoughData: "数据不足，无法生成本周摘要。",
    sub3Hint: "该时间范围内的有效结构化摘要少于 3 个。当有足够证据可用时，每周摘要将自动生成。",
    semanticDegradedHint: "找到了足够的摘要，但语义质量门控将此运行降级，以防止低信号片段。",
  ...
  dashboard: {
    ...
    explore: {
      ...
      starterDecks: [
        {
          ...
          description: "提出一个聚焦的问题，让「探索」帮你搜索、总结并拼接所需的最小上下文",
          privacyTip: "保持提示聚焦。询问主题、决策或某个时间窗口，而非原始对话记录。",
          capabilityHint: "这里支持摘要、每周汇总以及有来源依据的答案。",
          prompts: [
            {
              title: "总结本周",
        ...
        },
        {
          ...
          privacyTip: "优先使用主题、阻碍或结果这类描述词。避免一次性索取全部内容。",
          ...
          prompts: [
            ...
            {
              title: "归类阻碍",
              prompt: "归类我对话中反复出现的阻碍或未解问题。",
              detail: "有助于揭示反复出现的痛点，以及讨论反复回到哪里。",
            },
            {
              title: "追踪某个主题",
        ...
        },
        {
          ...
          capabilityHint: "可以索取每周摘要、跨对话主题，或一份可手动检查的来源清单。",
          prompts: [
            {
              title: "每周回顾",
              prompt: "给我一份简洁的每周回顾，包含主要主题和后续事项。",
              detail: "为保持简洁又实用的每周汇总而设计。",
            },
            {
              title: "主题图谱",
      ...
      toolExplanations: {
        ...
        weekly_summary_tool: "查找该时间段内的对话，然后复用或生成周级别的汇总。",
