...
For active backend-adjacent implementation, use:
- `frontend/` for current capture/runtime/offscreen implementation
- `documents/capture_engine/` for current parser and capture specifications
